// let arr = [{key: 'academy'}, undefined, true, [1,2,false,undefined], 1150];
...
let arr2 = ['hello', false, [1,'cool',3], {color: 'blue', size: 50}, 100];
...
arr2.forEach(function (elem) {console.log(elem)});
...
let activities = ['swimming', 'running', 'yoga', 'biking', 'climbing'];
console.log("Original Array: " + activities);

activities.splice(0,0,'stretching');
console.log("Array with stretching spliced in: " + activities);

activities.splice(3,1,'basketball');
console.log("Array with basketball spliced in & yoga removed: " + activities);

let otherActivities = activities.slice(2,5);
console.log("Array of a slice of activities: " + otherActivities);
...
objArr.forEach((key) => {console.log(obj[key])});